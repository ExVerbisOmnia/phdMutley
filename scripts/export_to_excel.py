...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler(log_dir / "export_to_excel.log"), logging.StreamHandler()],
)
            ...
            for table_name in sorted(tables):
                ...
                try:
                    ...
                    for col in df.columns:
                        ...
                        if not non_null_values.empty and isinstance(
                            non_null_values.iloc[0], (list, tuple)
                        ):
                            try:
