...
# =============================================================================
# SIXFOLD CLASSIFICATION TYPES
# =============================================================================

class SixfoldType:
    """Enumeration of sixfold citation classification types."""
...
class SixfoldClassificationEngine:
    ...
    def update_unique_citations(self, dry_run: bool = False) -> int:
        ...
        if top_cases:
            ...
            for row in top_cases:
                name = row['case_name'][:50] + '...' if len(row['case_name']) > 50 else row['case_name']
    ...
    def run_full_classification(self, dry_run: bool = False,
                                 classification_only: bool = False,
                                 tracking_only: bool = False) -> Dict[str, int]:
        """
