...
# This file should have columns: 'Case ID', 'Document Content URL', 'Geography ISOs'
...
BASE_OUTPUT_DIR = '/home/gusrodgs/Gus/cienciaDeDados/phdMutley/scripts/phase1/pdfs/downloaded'

# Column names from the Excel database
# These must match the exact column names in your baseCompleta.xlsx file
...
def process_database(database_path):
    ...
    for idx, row in df.iterrows():
        ...
        # Create the filename using the Case ID
        # Format: "case_{case_id}.pdf" (e.g., "case_BR-2021-1234.pdf")
        filename = f"case_{sanitize_filename(str(case_id))}.pdf"
